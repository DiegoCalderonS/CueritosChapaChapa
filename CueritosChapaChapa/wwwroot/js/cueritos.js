...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({
        "ajax": {
            "url": "/Admin/Cueritos/ObtenerTodos"
        },
        "columns": [
                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            <a href="/Admin/Cueritos/Upsert/${data}" class="btn btn-success text-white" style="cursor:pointer">
                                <i class="bi bi-pencil-square"></i>
                            </a>  
                            <a onclick=Delete("/Admin/Cueritos/Delete/${data}")>
